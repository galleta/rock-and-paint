...
public class atributos
{
  ...
  /**
   * <p><u>Descripción</u>: Esta función devuelve el grosor de línea</p>
  ...
  /**
   * <p><u>Descripción</u>: Esta función devuelve el nivel de transparencia</p>
  ...
  /**
   * <p><u>Descripción</u>: Esta función devuelve el color 1 del degradado</p>
  ...
  /**
   * <p><u>Descripción</u>: Esta función devuelve el color 2 del degradado</p>
  ...
  /**
   * <p><u>Descripción</u>: Esta función devuelve el tamaño de la fuente si es texto</p>
  ...
  /**
   * <p><u>Descripción</u>: Esta función devuelve si la letra está en negrita si es texto</p>
  ...
  /**
   * <p><u>Descripción</u>: Esta función devuelve si la letra está en cursiva si es texto</p>
  ...
  /**
   * <p><u>Descripción</u>: Esta función devuelve si la letra está subrayada si es texto</p>
   * @return Verdadero si está subrayada y falso sino
   */
  ...
  /**
   * <p><u>Descripción</u>: Esta función devuelve si la letra está tachada si es texto</p>
   * @return Verdadero si está tachada y falso sino
   */
  ...
  /**
   * <p><u>Descripción</u>: Esta función devuelve el nombre de la fuente si es texto</p>
  ...
  /**
   * <p><u>Descripción</u>: Esta función devuelve el punto para dibujar el texto</p>
