...
public class Ventana_formas extends JInternalFrame
{
  ...
  private void jbInit() throws Exception
  {
    ...
    tbBotonRectanguloRedondeado.setToolTipText("Rectángulo redondeado");
  ...
  {
    // La estrella es una forma añadida por mi :D
  ...
  {
    // La goma de borrar es una forma añadida por mi :D
